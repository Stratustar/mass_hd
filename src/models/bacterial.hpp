#ifndef MODELS_BACTERIAL_HPP_
#define MODELS_BACTERIAL_HPP_

#include "models/lyotropic-with-division.hpp"

class Bacterial : public LyotropicWithDivision
{
protected:
  ...
  /** Growth stress: -k_growth*R_div*Q */
  double k_growth = 0.;
  ...
  double ProliferationRate(unsigned) const;
...
public:
  Bacterial(unsigned, unsigned, unsigned);
