#ifndef MODELS_LYOTROPIC_WITH_DIVISION_HPP_
#define MODELS_LYOTROPIC_WITH_DIVISION_HPP_

#include "models/lyotropic.hpp"

class LyotropicWithDivision : public Lyotropic
{
protected:
  /** Mask for growth
   *
...
public:
  LyotropicWithDivision(unsigned, unsigned, unsigned);
...
#endif//MODELS_LYOTROPIC_WITH_DIVISION_HPP_
