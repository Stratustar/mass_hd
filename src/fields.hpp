...
template<class NodeType>
inline void Field<NodeType>::ApplyPBC(Wall w)
{
...
template<class NodeType>
inline void Field<NodeType>::ApplyPBC(Corner c)
{
  field[GetIndex(c)] = field[next(GetIndex(opp(c)), c)];
}

template<class NodeType>
inline void Field<NodeType>::ApplyPBC(Corner c, Wall w)
{
...
template<class NodeType>
inline void Field<NodeType>::ApplyPBC(PBCWall w)
{
